...
namespace RealEstateApp.CustomControls
{
    ...
    public class AnimatedHeaderedContentControl : HeaderedContentControl
    {
        ...
        public bool UseFloatSize { get; set; }
        ...
        public void AnimateSize(double width, double height)
        {
            ...
            if (this.Parent != null)
            {
                ...
                this.sizeAnimationWidthKeyFrame.Value = UseFloatSize ? width : System.Math.Floor(width);
                this.sizeAnimationHeightKeyFrame.Value = UseFloatSize ? height : System.Math.Floor(height);
        ...
        public void AnimatePosition(double x, double y)
        {
            ...
            if (this.Parent != null)
            {
                ...
                this.positionAnimationXKeyFrame.Value = UseFloatSize ? x : System.Math.Floor(x);
                this.positionAnimationYKeyFrame.Value = UseFloatSize ? y : System.Math.Floor(y);
        ...
        private void SizeAnimation_Completed(object sender, EventArgs e)
        {
            ...
            (this as DragDockPanel).CalculateHeaderWidth();
        }
    }
}
